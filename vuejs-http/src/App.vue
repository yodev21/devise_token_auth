<template>
  <div id="app">
    ...
    <div>
      <h1>Task All</h1>
      <div v-for="task in tasks" :key="task.id">Task:{{ task.id}}, {{task.title}}, {{ task.content }}
...
export default{
  ...
  methods: {
    ...
    all_tasks(){
      axios.get("http://localhost:3000/v1/tasks", {
        headers: {
          "uid": this.uid,
          "access-token": this.access_token,
          "client": this.client
    ...
    find_task(task_id){
      axios.get(`http://localhost:3000/v1/tasks/${task_id}`,{
        headers: {
          "uid": this.uid,
          "access-token": this.access_token,
          "client": this.client
    ...
    create_task(){
      ...
      console.log(this.access_token)
      console.log(this.client)
      axios.post("http://localhost:3000/v1/tasks",{
        "uid": this.uid,
        "access-token": this.access_token,
        "client": this.client,
        title: this.title,
    ...
    delete_task(task_id){
      axios.delete(`http://localhost:3000/v1/tasks/${task_id}`,{
        headers:{
          "uid": this.uid,
          "access-token": this.access_token,
          "client": this.client
